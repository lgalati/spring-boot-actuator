...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> listProducts() {
        ...
        counterService.increment("guru.springframework.service.ProductService.listProducts");
        gaugeService.submit("guru.springframework.service.ProductService.listProducts.pageViewsPerMin", 6);
